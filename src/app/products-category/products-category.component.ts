...
id:number;
list:Product[]=[]
  // Injection du ActivatedRoute dans le constructeur->une instance dans cette classe 
  constructor(private route: ActivatedRoute) { }

  ngOnInit() {
   // this.id=this.route.snapshot.params['id']; synchrone
   // this.route.params.subscribe(res=>this.id=res['id']);asynchrone
   // this.route.paramMap.subscribe(res=>this.id=Number(res.get('id'))); asynchrone

  
    this.route.paramMap.subscribe(res=>{this.id=Number(res.get('id'));
